define([
	...
	describe('Directive: "sortable" ', function() {
		...
		beforeEach(function() {
			mocks.module('TT-UI.Common.Directives.Sortable');

			mocks.module(function(_$stateProvider_, _SORTABLE_) {
				$stateProvider = _$stateProvider_;
				SORTABLE = _SORTABLE_;
			});

			mocks.inject(function(_$compile_, _$rootScope_, _$state_, _$stateParams_, _$location_) {
				$compile     = _$compile_;
